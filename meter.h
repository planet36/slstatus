...
void left_char_meter(double x, char* meter, size_t meter_width, char fill, char unfill);
void right_char_meter(double x, char* meter, size_t meter_width, char fill, char unfill);
